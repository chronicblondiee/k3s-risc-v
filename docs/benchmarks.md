...
4k random bandwidth (iodepth 32), and the same fio tests through a
local-path PVC.

## Runs

| Run | k3s | Kernel | CPU 1T (ev/s) | CPU all (ev/s) | Mem W/R (MiB/s) | NVMe seq W/R | NVMe 4k rand W/R | PVC seq W / 4k rand R | Report |
|---|---|---|---|---|---|---|---|---|---|
<!-- newest-first: playbook 11 inserts summary rows below this line -->
| 20260711T105642 | v1.36.2+k3s1 | 6.18.35-current-spacemit | 791.16 | 6083.84 | 6551.75 / 13851.20 | 773MiB/s / 818MiB/s | 170MiB/s / 141MiB/s | 772MiB/s / 112MiB/s | [report](../benchmarks/results/k8s-rv2-01-20260711T105642.md) |
| 20260711T104227 | v1.36.2+k3s1 | 6.18.35-current-spacemit | 790.78 | 6087.41 | 6667.65 / 13197.13 | 772MiB/s / 819MiB/s | 160MiB/s / 195MiB/s | 773MiB/s / 153MiB/s | [report](../benchmarks/results/k8s-rv2-01-20260711T104227.md) |
